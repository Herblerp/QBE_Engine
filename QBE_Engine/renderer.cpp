...
void Renderer::initWindow()
{
	...
	window = SDL_CreateWindow("Vulkan Window", SDL_WINDOWPOS_CENTERED,
		SDL_WINDOWPOS_CENTERED, INITIAL_WINDOW_WIDTH, INITIAL_WINDOW_HEIGHT, flags);
	if (window == NULL) {
...
{
	VkApplicationInfo RendererInfo = {};
	RendererInfo.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
	RendererInfo.pEngineName = "LunarG SDK";
	RendererInfo.pApplicationName = "Vulkan C++ Windowed Program Template";
	RendererInfo.apiVersion = VK_API_VERSION_1_0;
	RendererInfo.engineVersion = VK_MAKE_VERSION(1, 0, 0);;
	RendererInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);;

	//Get necessary extenstions using SDL
	...
	instInfo.flags = VkInstanceCreateFlags();
	instInfo.pApplicationInfo = &RendererInfo;
...
{
	if (!SDL_Vulkan_CreateSurface(window, static_cast<VkInstance>(instance), &this->surface)) {
...
void Renderer::createTextureImage()
{
	...
	stbi_uc* pixels = stbi_load("textures/grass_texture_512.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
