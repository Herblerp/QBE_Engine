...
void App::initVulkan()
{
	...
	appInfo.pApplicationName = "Vulkan C++ Windowed Program Template";
...
void App::initDevice()
{
	...
	//Create queue info for each queue
	...
	if (vkCreateDevice(this->physicalDevice, &deviceInfo, nullptr, &this->device) != VK_SUCCESS) {
